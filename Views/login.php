        ...
        <div class="row flex-grow">
          <div class="col-lg-4 d-flex align-items-center justify-content-center">
            <div class="auth-form-transparent text-left p-3">
              ...
              <h4>Bienvenido!</h4>
              <h6 class="font-weight-light">¡Felices de verte de nuevo!</h6>
              ...
              <form class="pt-3" id="frmLogin" onsubmit="frmLogin(event)">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" class="form-control form-control-lg border-left-0" id="usuario" placeholder="Usuario" name="usuario">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="my-3">
                  <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" type="submit" id="btnAccion">Iniciar sesión</button>
                </div>
              </form>
            </div>
          </div>
